...
class folders {
	...
	/**
	 * This is the getter and setter for the views folder. This is the folder where the view 
	 * classes should be put in. By default this path is "views". See {@link autoroute.view} for
	 * what a view is.
